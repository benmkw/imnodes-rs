...
pub type ColorStyle = ::std::os::raw::c_int;
...
pub type StyleVar = ::std::os::raw::c_int;
...
pub type StyleFlags = ::std::os::raw::c_int;
...
pub type PinShape = ::std::os::raw::c_int;
...
pub type AttributeFlags = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
