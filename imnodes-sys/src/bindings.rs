...
pub const ImNodesCol__ImNodesCol_COUNT: ImNodesCol_ = 26;
...
pub const ImNodesStyleVar__ImNodesStyleVar_NodePaddingHorizontal: ImNodesStyleVar_ = 2;
pub const ImNodesStyleVar__ImNodesStyleVar_NodePaddingVertical: ImNodesStyleVar_ = 3;
pub const ImNodesStyleVar__ImNodesStyleVar_NodeBorderThickness: ImNodesStyleVar_ = 4;
...
pub struct ImNodesStyle {
    ...
    pub NodePaddingHorizontal: f32,
    pub NodePaddingVertical: f32,
    ...
    pub Colors: [::std::os::raw::c_uint; 26usize],
}
#[test]
fn bindgen_test_layout_ImNodesStyle() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<ImNodesStyle>())).NodePaddingHorizontal as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ImNodesStyle),
            "::",
            stringify!(NodePaddingHorizontal)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<ImNodesStyle>())).NodePaddingVertical as *const _ as usize
        },
        12usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn imnodes_MiniMap(
        ...
        node_hovering_callback_data: *mut ::std::os::raw::c_void,
    );
}
extern "C" {
...
extern "C" {
    pub fn imnodes_PushStyleVar(style_item: ImNodesStyleVar, value: f32);
}
extern "C" {
